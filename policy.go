	...
	return []RolePolicy{
		{
			...
			Handles:          []anchor.Handle{0x81010001},
			Lifetime:         true,
			RotationInterval: 0,
		},
		{
			...
			Handles:          []anchor.Handle{0x81010010},
			Lifetime:         true,
			RotationInterval: 0,
		},
		{
			...
			Handles:          []anchor.Handle{0x81010020, 0x81010021},
			Lifetime:         false,
		...
		},
		{
			...
			Purpose:          PurposeCertificateAuthority,
			Algorithm:        anchor.AlgorithmECDSAP256,
			Handles:          []anchor.Handle{0x81010030, 0x81010031},
			Lifetime:         false,
			RotationInterval: operationalRotationInterval,
		},
		{
			...
			Purpose:          PurposeCertificateAuthority,
			Algorithm:        anchor.AlgorithmECDSAP256,
			Handles:          []anchor.Handle{0x81010040, 0x81010041},
			Lifetime:         false,
			RotationInterval: operationalRotationInterval,
		},
		{
			...
			Purpose:          PurposeCertificateAuthority,
			Algorithm:        anchor.AlgorithmECDSAP256,
			Handles:          []anchor.Handle{0x81010050, 0x81010051},
			Lifetime:         false,
			RotationInterval: operationalRotationInterval,
		},
		{
			...
			Purpose:          PurposeCertificateAuthority,
			Algorithm:        anchor.AlgorithmECDSAP256,
			Handles:          []anchor.Handle{0x81010060, 0x81010061},
			Lifetime:         false,
			RotationInterval: operationalRotationInterval,
		},
		{
			...
			Purpose:          PurposeCertificateAuthority,
			Algorithm:        anchor.AlgorithmECDSAP256,
			Handles:          []anchor.Handle{0x81010070, 0x81010071},
			Lifetime:         false,
			RotationInterval: operationalRotationInterval,
		},
		{
			...
			Purpose:          PurposeSigning,
			Algorithm:        anchor.AlgorithmECDSAP256,
			Handles:          []anchor.Handle{0x81010080},
			Lifetime:         true,
			RotationInterval: 0,
		},
		{
			...
			Purpose:          PurposeSigning,
			Algorithm:        anchor.AlgorithmECDSAP256,
			Handles:          []anchor.Handle{0x81010090},
			Lifetime:         true,
			RotationInterval: 0,
		},
		{
			...
			Purpose:          PurposeSigning,
			Algorithm:        anchor.AlgorithmECDSAP256,
			Handles:          []anchor.Handle{0x810100A0},
			Lifetime:         true,
			RotationInterval: 0,
		},
	}
